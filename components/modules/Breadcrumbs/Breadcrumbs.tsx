...
const generatePathMebls = (pathStr: string) => {
...
const Breadcrumbs = ({
  ...
  const breadcrumbs = useMemo(
    function generateBreadcrumbs() {
      const asPathNestedRoutes = generatePathMebls(router.asPath)
      const pathnameNestedRoutes = generatePathMebls(router.pathname)
